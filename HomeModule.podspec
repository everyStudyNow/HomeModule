...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/everyStudyNow/HomeModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'everyStudyNow' => '984013284@qq.com' }
  s.source           = { :git => 'https://github.com/everyStudyNow/HomeModule.git', :tag => s.version.to_s }
